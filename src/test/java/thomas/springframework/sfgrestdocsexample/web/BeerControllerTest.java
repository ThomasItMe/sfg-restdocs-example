package thomas.springframework.sfgrestdocsexample.web;
...
@ComponentScan(basePackages = {"thomas.springframework.sfgrestdocsexample.web.mappers"})
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("minOnHand").description("MinOnHand")
                        )
                ));
    }
